# How to contribute to  cozy-twakemail?
...
- What is the version of the  cozy-twakemail app?
...
```
$ git clone github.com/cozy/ cozy-twakemail.git
$ cd  cozy-twakemail
$ git remote add fork git://github.com/yourusername/ cozy-twakemail.git
```
...
Go to https://github.com/yourusername/ cozy-twakemail and select your branch. Click the 'Pull Request' button and fill out the form.
...
The  cozy-twakemail is translated on a platform called [Transifex][tx]. [This tutorial][tx-start] can help you to learn how to make your first steps here. If you have any question, don't hesitate to ask us!
...
[issues]: https://github.com/cozy/ cozy-twakemail/issues/new
...
[localization]: https://github.com/cozy/ cozy-twakemail/blob/master/README.md#localization
